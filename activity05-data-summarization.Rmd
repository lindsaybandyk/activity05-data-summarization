...
**Response**:
i keep getting an error with out the parenthessis because it does not focus on the correct platform, it stops the messages tobe able to be seen. 
...
i think that based on the distribution of median earnings that 
